...
{
    public class AccessConnectionSection : ConfigurationSection
    {
        ...
        public static IAccessConnectionConfiguration GetConfiguration()
        {
            var section = ConfigurationSectionProvider.Open<AccessConnectionSection>("shuttle", "accessConnection");
            var configuration = new AccessConnectionConfiguration();
