...
namespace Shuttle.Access.Data.Migrations
{
    ...
    [Migration("20260323193020_RoleIdentities_Migration")]
    partial class RoleIdentities_Migration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Shuttle.Access.SqlServer.Models.Session", b =>
                {
                    ...
                    b.HasIndex(new[] { "IdentityId", "TenantId" }, "UX_Session_IdentityId_TenantId")
                        .IsUnique();
