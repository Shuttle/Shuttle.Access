...
namespace Shuttle.Access.Data.Migrations
{
    ...
    [Migration("20260823052709_TenantMaximumIdentities_Migration")]
    partial class TenantMaximumIdentities_Migration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shuttle.Access.SqlServer.Models.Role", b =>
                {
                    ...
                    b.HasIndex(new[] { "Id" }, "UX_Role_Id")
                        .IsUnique();

                    b.HasIndex(new[] { "TenantId", "Name" }, "UX_Role_TenantId_Name")
                        .IsUnique();
            ...
            modelBuilder.Entity("Shuttle.Access.SqlServer.Models.SessionPermission", b =>
                {
                    ...
                    b.HasKey("SessionId", "TenantId", "PermissionId");
            ...
            modelBuilder.Entity("Shuttle.Access.SqlServer.Models.SessionToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex(new[] { "SessionId", "TokenHash" }, "UX_SessionToken_SessionId_TokenHash")
                        .IsUnique();

                    b.ToTable("SessionToken", "access");
                });
            ...
            modelBuilder.Entity("Shuttle.Access.SqlServer.Models.Tenant", b =>
                {
                    ...
                    b.Property<int>("MaximumIdentities")
                        .HasColumnType("int");
