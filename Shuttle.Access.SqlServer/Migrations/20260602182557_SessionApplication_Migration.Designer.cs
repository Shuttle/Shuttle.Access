...
namespace Shuttle.Access.Data.Migrations
{
    ...
    [Migration("20260602182557_SessionApplication_Migration")]
    partial class SessionApplication_Migration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Shuttle.Access.SqlServer.Models.Session", b =>
                {
                    ...
                    b.HasIndex(new[] { "IdentityId", "Application" }, "UX_Session_IdentityId_Application")
                        .IsUnique();

                    b.HasIndex(new[] { "TokenHash" }, "UX_Session_TokenHash")
                        .IsUnique();
