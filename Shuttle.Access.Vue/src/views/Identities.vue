    ...
    <v-card flat>
        ...
        <a-data-table :items="items" :headers="headers" :mobile="null" mobile-breakpoint="md" v-model:search="search"
            ...
            <template v-slot:header.action="">
                <v-btn-primary v-if="sessionStore.hasPermission(Permissions.Identities.Manage)" :icon="mdiPlus"
                    size="x-small" @click="add"></v-btn-primary>
            </template>
...
import { mdiMagnify, mdiDelete, mdiPlus, mdiRefresh, mdiPencil, mdiAccountGroupOutline, mdiKey, mdiDomain } from '@mdi/js';
