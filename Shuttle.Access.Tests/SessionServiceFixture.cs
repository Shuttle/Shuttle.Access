...
public class SessionServiceFixture
{
    ...
    public async Task Should_be_able_check_for_non_existent_session_async()
    {
        ...
        var service = new SessionService(new Mock<ILogger<SessionService>>().Object, Options.Create(new AccessOptions()), new Mock<IHttpContextAccessor>().Object, new NullSessionCache(), sessionQuery.Object, new Mock<IMediator>().Object);
