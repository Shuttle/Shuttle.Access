...
public static class KnownApplicationEndpoints
{
    public static WebApplication MapApplicationEndpoints(this WebApplication app, ApiVersionSet versionSet)
    {
        ...
        app.MapGet("/v{version:apiVersion}/applications/{applicationName}", Get)
    ...
    private static IResult Get(IOptions<AccessOptions> accessOptions, string applicationName)
    {
        ...
        var result = new KnownApplication { Name = knownApplicationOptions.Name, Title = knownApplicationOptions.Title, Description = knownApplicationOptions.Description };
