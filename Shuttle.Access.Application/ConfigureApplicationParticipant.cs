    ...
    : IParticipant<ConfigureApplication>
{
    ...
    public async Task HandleAsync(ConfigureApplication message, CancellationToken cancellationToken = default)
    {
        ...
        logger.LogDebug("Registering system administrator with identity name '{SystemAdministratorIdentityName}'.", accessOptions.Value.SystemAdministratorIdentityName);
